...
$stdoutPath = Join-Path $PSScriptRoot "..\..\godot_verify_stdout.txt"
$stderrPath = Join-Path $PSScriptRoot "..\..\godot_verify_stderr.txt"
...
$args = @(
    "--headless",
    "--path", $projectPath,
    "-s", "res://scripts/tests/commercial_slice_whitebox_verifier.gd"
)
