...
const MODEL_PATH := "res://assets/models/generated/momentum_circuit_v9/momentum_circuit_environment_v9.glb"
...
func _initialize() -> void:
	print("==================================================")
	print("[Momentum Circuit v9 Environment Verifier]")
	print("==================================================")
	...
	_expect_int(initial, "ring_instance_count", 0)
	_expect_int(initial, "traffic_route_count", 3)
	_expect_int(initial, "sensor_scan_count", 0)
	_expect_int(initial, "active_motion_system_count", 1)
...
func _finish() -> void:
	if _failures.is_empty():
		print("RESULT momentum_circuit_environment_v9 passed=true")
		print("[Momentum Circuit v9 Environment Verifier] PASS")
		quit(0)
		return
	print("RESULT momentum_circuit_environment_v9 passed=false failures=%d" % _failures.size())
	print("[Momentum Circuit v9 Environment Verifier] FAIL")
