...
$stdoutPath = Join-Path $PSScriptRoot "..\..\godot_twin_bays_stdout.txt"
$stderrPath = Join-Path $PSScriptRoot "..\..\godot_twin_bays_stderr.txt"
...
$args = @(
    ...
    "--audio-driver", "Dummy",
    "--path", $projectPath,
    "-s", "res://scripts/tests/twin_bays_whitebox_verifier.gd"
)
