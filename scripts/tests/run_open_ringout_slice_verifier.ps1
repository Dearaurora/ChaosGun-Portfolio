...
$stdoutPath = Join-Path $PSScriptRoot "..\..\godot_open_ringout_stdout.txt"
$stderrPath = Join-Path $PSScriptRoot "..\..\godot_open_ringout_stderr.txt"
...
$args = @(
    "--headless",
    "--path", $projectPath,
    "-s", "res://scripts/tests/open_ringout_slice_verifier.gd"
)
