...
$stdoutPath = Join-Path $PSScriptRoot "..\..\godot_a1_playtest_preset_stdout.txt"
$stderrPath = Join-Path $PSScriptRoot "..\..\godot_a1_playtest_preset_stderr.txt"
...
$args = @(
    "--headless",
    "--path", $projectPath,
    "-s", "res://scripts/tests/a1_reference_playtest_preset_verifier.gd"
)
